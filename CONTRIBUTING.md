...
1. Reporting an issue or making a feature request [here](https://github.com/cloud-ca/cca/issues).
...
1. Fork and *git clone* [cca](https://github.com/cloud-ca/cca).
2. Create a new *git branch* from the master branch where you develop your changes.
3. Create a [Pull Request](https://help.github.com/articles/about-pull-requests/) for your contribution by following the instructions in the pull request template [here](https://github.com/cloud-ca/cca/pull).
...
2. **Documentation**: Pull requests need to update the [documentation](https://github.com/cloud-ca/cca/tree/master/README.md) together with the code change.
